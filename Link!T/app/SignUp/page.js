...
const Signup = () => {
  ...
  return (
    <div className="flex justify-center lg:justify-between lg:pl-[9rem] xl:pl-[14rem] gap-5 sm:gap-[3rem bg-[#d5a334]">
      <div className="flex items-center min-h-screen bg-[#d5a334]">
        <div className="pt-40 w-full max-w-md bg-white rounded-2xl shadow-md p-8 text-center">
          {/* Logo / Heading */}
          <h1 className="text-3xl font-bold mb-2 text-gray-900">Join LINK!T</h1>
      ...
      <div className="hidden lg:block h-screen w-[50%] overflow-hidden"><img className="h-full w-full object-cover" src="https://linktr.ee/universal-login/assets/banner-signup-desktop-Dq7usIXX.webp" alt="" /></div>
    </div>
  );
};
